...
lint:
	...
	yes | sudo ./cmdline-tools/bin/sdkmanager --licenses --sdk_root=$ANDROID_HOME
	yes | sudo ./cmdline-tools/bin/sdkmanager "build-tools;34.0.0-rc3" --sdk_root=$ANDROID_HOME
	./gradlew lint test
upgrade:
